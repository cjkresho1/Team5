...
public class Warehouse {
	 ...
	 * @return Information about part sold. Empty string (ie: "") if sale isn't
	 *         possible.
	 */
	...
	public PartQuantity[] sortNumber() {
		 ...
		 * Comparator<PartQuantity> passed to the method is a custom, overridden
		 * Comparator that is designed to compare the numbers.
		 */
		parts.sort(new Comparator<PartQuantity>() {
			@Override
			public int compare(PartQuantity b1, PartQuantity b2) {
